...
public class TypescriptUtility {
	...
	private static final String CLIENT_INTERFACE_PATH = "../../bundles/com.github.cabutchei.rsp.api/src/main/java/com.github.cabutchei/api/RSPClient.java";
	private static final String SERVER_INTERFACE_PATH = "../../bundles/com.github.cabutchei.rsp.api/src/main/java/com.github.cabutchei/api/RSPServer.java";
	...
	public void writeTypescriptSchemas(Class<?>[] daoClasses) throws IOException {
		...
		settings.optionalAnnotations.add(com.github.cabutchei.rsp.api.dao.util.Optional.class);
