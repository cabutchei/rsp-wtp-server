...
import com.github.cabutchei.rsp.launching.utils.URLUtils;
...
public final class LibraryLocation {
	public static final String libraryLocation_assert_libraryNotNull="library cannot be null";
	...
	public LibraryLocation(IPath libraryPath, IPath sourcePath, IPath packageRoot, URL javadocLocation, URL indexLocation, IPath externalAnnotations) {
		if (libraryPath == null) {
			throw new IllegalArgumentException(libraryLocation_assert_libraryNotNull);
		}
