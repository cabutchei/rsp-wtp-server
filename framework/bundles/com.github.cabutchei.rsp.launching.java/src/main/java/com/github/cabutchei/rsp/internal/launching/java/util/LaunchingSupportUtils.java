 ...
 ******************************************************************************/
package com.github.cabutchei.rsp.internal.launching.java.util;
...
import com.github.cabutchei.rsp.eclipse.jdt.internal.launching.LibraryInfo;
import com.github.cabutchei.rsp.eclipse.jdt.launching.IJavaLaunchConfigurationConstants;
...
import com.github.cabutchei.rsp.eclipse.jdt.launching.VMRunnerConfiguration;
import com.github.cabutchei.rsp.eclipse.osgi.util.NLS;
import com.github.cabutchei.rsp.launching.utils.ExecUtil;
	...
	public File getLaunchingSupportFile() {
		...
		if( destination == null ) {
			...
			if( !destination.exists() || destination.length() <= 0 ) {
				...
				if( is == null ) {
					String url = "https://raw.githubusercontent.com/redhat-developer/rsp-server/v0_26_2/framework/bundles/com.github.cabutchei.rsp.launching.java/src/main/resources/launchingsupport.jar";
					try {
