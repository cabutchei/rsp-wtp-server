 ...
 *******************************************************************************/
package com.github.cabutchei.rsp.eclipse.debug.core;
...
import com.github.cabutchei.rsp.eclipse.debug.core.model.IDisconnect;
 ...
 * @see ILaunchManager
 */
public class Launch  implements ILaunch, IDisconnect  { //ILaunchListener, ILaunchConfigurationListener, IDebugEventSetListener {
...
//	private ISourceLocator fLocator= null;
	 ...
	 */
	public Launch(/*ILaunchConfiguration*/ Object launchConfiguration, String mode, /*ISourceLocator*/ Object locator) {
		fMode = mode;
...
//		getLaunchManager().addLaunchConfigurationListener(this);
	...
	/**
	 * @see com.github.cabutchei.rsp.eclipse.debug.core.model.ITerminate#canTerminate()
	 */
	@Override
...
//			}
	...
	public Object[] getChildren() {
		...
		try {
			...
			//children.addAll(getDebugTargets0());
...
//	}
	...
	/**
	 * @see com.github.cabutchei.rsp.eclipse.debug.core.model.ITerminate#isTerminated()
	 */
	@Override
...
//			}
	...
	/**
	 * @see com.github.cabutchei.rsp.eclipse.debug.core.model.ITerminate#terminate()
	 */
	@Override
...
//			((LaunchManager)getLaunchManager()).fireUpdate(new ILaunch[] {this}, LaunchManager.TERMINATE);
     ...
     *
	 * @see com.github.cabutchei.rsp.eclipse.debug.core.model.IDisconnect#canDisconnect()
	 */
	@Override
...
//			}
	...
	/**
	 * @see com.github.cabutchei.rsp.eclipse.debug.core.model.IDisconnect#disconnect()
	 */
	@Override
...
//			}
     ...
     * counted.
     *
	 * @see com.github.cabutchei.rsp.eclipse.debug.core.model.IDisconnect#isDisconnected()
	 */
	@Override
