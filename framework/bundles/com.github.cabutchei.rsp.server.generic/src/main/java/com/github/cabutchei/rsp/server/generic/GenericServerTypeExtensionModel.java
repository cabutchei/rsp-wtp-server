...
import com.github.cabutchei.rsp.server.generic.discovery.ExplodedManifestDiscovery;
import com.github.cabutchei.rsp.server.generic.discovery.GenericServerBeanTypeProvider;
import com.github.cabutchei.rsp.server.generic.discovery.JarManifestDiscovery;
import com.github.cabutchei.rsp.server.generic.discovery.PropertiesFileDiscovery;
import com.github.cabutchei.rsp.server.generic.discovery.XmlFileDiscovery;
import com.github.cabutchei.rsp.server.generic.runtimes.download.GenericDownloadRuntimesProvider;
import com.github.cabutchei.rsp.server.generic.servertype.GenericServerType;
...
public class GenericServerTypeExtensionModel implements IServerBehaviorFromJSONProvider {
	...
	private void loadServerType(String serverTypeId, 
		...
		if( attributes != null ) {
			...
			staticVals = attributes.getChild("staticDefaults");
		}
