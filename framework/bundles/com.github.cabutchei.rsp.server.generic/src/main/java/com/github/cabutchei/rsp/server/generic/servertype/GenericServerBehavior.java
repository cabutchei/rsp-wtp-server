 ...
 ******************************************************************************/
package com.github.cabutchei.rsp.server.generic.servertype;
...
import com.github.cabutchei.rsp.foundation.core.launchers.IStartLauncher;
...
import com.github.cabutchei.rsp.server.generic.IPublishControllerWithOptions;
import com.github.cabutchei.rsp.server.generic.IStringSubstitutionProvider;
import com.github.cabutchei.rsp.server.generic.servertype.launch.GenericJavaLauncher;
import com.github.cabutchei.rsp.server.generic.servertype.launch.NoOpLauncher;
import com.github.cabutchei.rsp.server.generic.servertype.launch.TerminateShutdownLauncher;
import com.github.cabutchei.rsp.server.generic.servertype.variables.ServerStringVariableManager;
import com.github.cabutchei.rsp.server.generic.servertype.variables.ServerStringVariableManager.IExternalVariableResolver;
import com.github.cabutchei.rsp.server.generic.servertype.variables.StringSubstitutionEngine;
...
import com.github.cabutchei.rsp.server.spi.launchers.AbstractJavaLauncher;
...
import com.github.cabutchei.rsp.server.spi.model.polling.AbstractPoller;
import com.github.cabutchei.rsp.server.spi.model.polling.IPollResultListener;
import com.github.cabutchei.rsp.server.spi.model.polling.IServerStatePoller;
import com.github.cabutchei.rsp.server.spi.model.polling.IServerStatePoller.SERVER_STATE;
import com.github.cabutchei.rsp.server.spi.model.polling.PollThreadUtils;
import com.github.cabutchei.rsp.server.spi.model.polling.WebPortPoller;
...
public class GenericServerBehavior extends AbstractServerDelegate
	...
	public StartServerResponse start(String mode) {
		...
		if( !stat.isOK()) {
			com.github.cabutchei.rsp.api.dao.Status s = StatusConverter.convert(stat);
		...
		try {
			...
			setServerState(IServerDelegate.STATE_STOPPED);
			com.github.cabutchei.rsp.api.dao.Status s = StatusConverter.convert(ce.getStatus());
