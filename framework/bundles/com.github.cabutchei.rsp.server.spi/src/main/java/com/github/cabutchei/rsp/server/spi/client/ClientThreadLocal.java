 ...
 ******************************************************************************/
package com.github.cabutchei.rsp.server.spi.client;
...
public class ClientThreadLocal {
	 private static MessageContextStore<RSPWTPClient> activeClient;
	 
	 public synchronized static MessageContextStore<RSPWTPClient> getStore() {
	 ...
	 public synchronized static RSPWTPClient getActiveClient() {
		 MessageContext<RSPWTPClient> context = getStore().getContext();
		 return context == null ? null : context.getRemoteProxy();
	 }
	 
	 public synchronized static void setActiveClient(RSPWTPClient client) {
		 getStore().setContext(new MessageContext<RSPWTPClient>(client));
	 }
}
