...
public class ExplodedManifestDiscoveryTest {
	...
	private String getUnifiedManifestContents(String name, String version) {
		return 	"Manifest-Version: 1.0\n" + 
				...
				"Bundle-Name: " + name + "\n" + 
				"Bundle-SymbolicName: com.github.cabutchei.rsp.server.generic.test.generic.test\n" + 
				"Automatic-Module-Name: com.github.cabutchei.rsp.server.generic.test.generic.test\n" + 
	...
	private String getVersionManifestContents(String version) {
		return 	"Automatic-Module-Name: com.github.cabutchei.rsp.server.generic.test.generic.test\n" + 
				"Bundle-Version: " + version + "\n" + 
				"Bundle-RequiredExecutionEnvironment: JavaSE-1.8\n";
	}
