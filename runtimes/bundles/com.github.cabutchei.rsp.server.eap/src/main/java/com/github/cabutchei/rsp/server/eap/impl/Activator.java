...
public class Activator extends RSPExtensionBundle {
	public static final String BUNDLE_ID = "com.github.cabutchei.rsp.server.eap";
	private static final Logger LOG = LoggerFactory.getLogger(Activator.class);
	private static final EapServerTypeHandler WST_HANDLER = new EapServerTypeHandler();
