 ...
 ************************************************************************************/
package com.github.cabutchei.rsp.server.redhat.download;
...
import com.github.cabutchei.rsp.runtime.core.model.IDownloadRuntimeConnectionFactory;
import com.github.cabutchei.rsp.runtime.core.model.IDownloadRuntimeWorkflowConstants;
import com.github.cabutchei.rsp.runtime.core.util.DownloadRuntimeSessionCache;
import com.github.cabutchei.rsp.runtime.core.util.DownloadRuntimeSessionCache.DownloadManagerSessionState;
import com.github.cabutchei.rsp.secure.model.ISecureStorageProvider;
import com.github.cabutchei.rsp.server.redhat.credentials.RedHatAccessCredentials;
...
public abstract class AbstractDownloadManagerExecutor 
	...
	protected WorkflowResponse handleCredentials(DownloadSingleRuntimeRequest req) {
		...
		if (submittedUser == null || submittedPassword == null || submittedUser.isEmpty() || submittedPassword.isEmpty()) {
