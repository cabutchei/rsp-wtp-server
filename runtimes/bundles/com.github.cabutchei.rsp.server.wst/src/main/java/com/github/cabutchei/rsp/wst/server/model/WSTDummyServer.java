...
import com.github.cabutchei.rsp.eclipse.wst.WstServerProxy;
...
public class WSTDummyServer extends WSTBase implements IServer {
	...
	public WSTDummyServer(IServerModel serverModel, IServerManagementModel managementModel) {
